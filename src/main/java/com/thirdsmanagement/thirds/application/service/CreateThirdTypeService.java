...
public class CreateThirdTypeService implements CreateThirdTypeUseCase {
     ...
     * @throws ThirdTypeInvalidDataException si el tipo de tercero es null o tiene datos inválidos
    ...
    /**
     * Valida que no exista un tipo de tercero con el mismo nombre (case-insensitive).
