...
public class IdPersistenceAdapter implements IdOutputPort {
     ...
     */
    @Override
    public Page<ThirdType> getAllActiveThirdTypesWithSort(String entId, int page, int size, String sortField,
            String sortOrder) {
     ...
     */
    @Override
    public Page<ThirdType> findActiveThirdTypesByEntIdAndSearch(String entId, String search, int page, int size,
            String sortField, String sortOrder) {
        String entitySortField = mapThirdTypeSortField(sortField);
        Sort sort = "desc".equalsIgnoreCase(sortOrder)
                ? Sort.by(entitySortField).descending()
    ...
    /**
     * Mapea el campo de ordenamiento del modelo ThirdType al campo correspondiente
     * en ThirdTypeEntity.
     * 
     * @param sortField Campo de ordenamiento del modelo
     * @return Campo de ordenamiento de la entidad
